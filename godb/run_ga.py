...
def evaluate(guy, prop=None, folds=5):
#def evaluate(guy, prop=0.01, folds=None):
    (I, sfolds), BI = guy
    ...
    score = Orange.evaluation.scoring.RMSE(res)[0]
    return score
...
class ParEv:
    ...
    def __call__(self, pop):
        ...
        uniq_pop = [ (I, set(v)) for (I, v) in set(frozen_pop) ]
